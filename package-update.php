   ...
   <?php //UPDATING PACKAGE
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
      ...
      if ($packageResult === TRUE) {
        ...
        //for loop if packlist rows < 0
        for ($j = 0; $j < $count; $j++) {

          //Update package_list table
          $listquery = "UPDATE package_list SET pack_list_model = '".$_POST['packlist'][$j]."', pack_list_qty = '".$_POST['packlistQty'][$j]."' WHERE packId = '$id' ";
