          ...
          if($result = mysqli_query($link, $sql_check)){ //Execute query
           if(mysqli_num_rows($result) > 0){
            ...
            mysqli_free_result($result);
                                      ...
                                      $query = "
                                      INSERT INTO warehouse (name, address, created_by, created_at)
                                      VALUES ('$name', '$address', '$account', '$startDate')"; //Prepare insert query
                                              ...
                                              <div class="card-body">
                                                <form  method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                                  <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Warehouse Name" name="name" oninput="upperCase(this)" maxlength="20" required>
                                                  </div>

                                                  <div class="form-group">
                                                    <label>Warehouse Address</label>
                                                    <input type="text" class="form-control" placeholder="Address" name="address" oninput="upperCase(this)" required>
                                                  </div>
