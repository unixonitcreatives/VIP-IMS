            ...
            <div class="card">
              <div class="card-header">
                <div class="d-flex justify-content-between">
                  <h3 class="card-title">Manage Stockist</h3>
                  <a href="stockist-add.php">+ Add New Stockist</a>
                </div>
              </div>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                      ...
                      <tbody>
                        ...
                        $query = "SELECT * FROM stockist ORDER BY id DESC";
                        if($result = mysqli_query($link, $query)){
                          if(mysqli_num_rows($result) > 0){
                            ...
                            while($row = mysqli_fetch_array($result)){
                              ...
                              echo "<td>" . $row['area_center'] . "</td>";
                              echo "<td>" . $row['created_by'] . "</td>";
                              echo "<td>" . $row['created_at'] . "</td>";
                              echo "<td>";
                             /* echo "<a href='stock-transfer.php?id=".$row['id']." ' title='Transfer Stocks' data-toggle='tooltip'><span class='fas fa fa-boxes'></span></a>";*/
                              
                              echo " &nbsp; <a href='stockist-update.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip'><span class='fas fa-pen'></span></a>";

                              echo " &nbsp; <a href='stockist-delete.php?id=".$row['id']."' title='Delete Record' data-toggle='tooltip' onclick='return checkDelete()'><span class='fas fa fa-trash'></span></a>";
